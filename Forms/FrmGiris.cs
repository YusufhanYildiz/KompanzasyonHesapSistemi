    ...
    public partial class FrmGiris : Form
    {
        ...
        private async void btnDemoGiris_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                // Güvenilir saati al (İnternet varsa internetten, yoksa sistemden)
                DateTime currentTime = await timeService.GetReliableTimeAsync();
                ...
                if (licenseInfo == null || licenseInfo.HardwareId != hardwareId)
                {
                    ...
                    licenseInfo = new LicenseInfo
                    {
                        ...
                        StartDate = currentTime // Güvenilir saati kullan
                    };
                    licenseService.SaveLicense(licenseInfo);
